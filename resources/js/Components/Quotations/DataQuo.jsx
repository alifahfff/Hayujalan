                    ...
                    {quotation.map((cr, index) => {
                        ...
                        return (
                            <tbody key={index}>
                                ...
                                <td className="whitespace-nowrap px-6 py-4 font-medium">{cr.namaKlien}</td>
                                <td className="whitespace-nowrap px-6 py-4 font-medium">{cr.quotation.area_wisata.namaArea}</td>
                                <td className="whitespace-nowrap px-6 py-4">{cr.sellingPrice}</td>
