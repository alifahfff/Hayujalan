...
const ModalDeleteKT = ({visible, onClose, data}) => {
                    ...
                    <h1 className="font-semibold text-center text-xl text-gray-700 pb-3">Apakah anda yakin ingin menghapus data ini ?</h1>
                        ...
                        <div className="card-actions justify-end">
                            ...
                            <button  
                                ...
                                onClick={onClose}
                            ><Link href={route('delete.kategoriTour')} method="post" data={{ id: data.idKategoriTour }} as="button">
                            IYA
                            </Link></button>
                        </div> 
                    </div>
