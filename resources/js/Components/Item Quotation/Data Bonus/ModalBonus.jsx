...
const ModalBonus = ({ visible, onClose, data }) => {
  ...
  const handleSubmit = () => {
    ...
    if (!datas.ketDataBonus) {
      newInputErrors.ketDataBonus = "Ket Bonus harus dipilih";
    }
    if (!datas.biayaDataBonus) {
      newInputErrors.biayaDataBonus = "Biaya Bonus harus diisi";
    }
    if (!datas.satuanBonus) {
      newInputErrors.satuanBonus = "Satuan Bonus harus diisi";
    }
          ...
          <div className="">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-row justify-between">
                ...
                />
                {inputErrors.satuanBonus && (
                  <p className="text-red-500 mt-1">{inputErrors.satuanBonus}</p>
                )}
              </div>
            </div>
            {/* Button */}
