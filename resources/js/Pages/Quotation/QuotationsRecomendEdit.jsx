...
const QuotationsRecomendEdit = (props, crewL) => {
 ...
 const [datas, setDatas] = useState({
   ...
   idSales: props.userQuotation.user_quotations[0].idUser,
   namaSales: props.userQuotation.user_quotations[0].namaUser,
   ...
   bref_kategori: props.data.bref_kategori,
   bref_areaWisata: props.data.bref_areaWisata,
   bref_jumlahOrang: props.data.bref_jumlahOrang,
   bref_durasi: props.data.bref_durasi,
   bref_budget: props.data.bref_budget,
 })
...
const handleDateChange = (e, nama) => {
 ...
 const handleSubmit = () => {
  ...
  console.log('budget', bref_budget2)
   ...
   Inertia.post('/quotationrecomend/add', data)
 ...
 return (
   <div className="min-h-screen bg-abu ">
     {/* Content */}
     <div className="ml-6">
       <a>Quotation Rekomendasi Edit</a>
     </div>
     <div className="flex m-6 mt-2 mb-3">
       <a className="text-2xl font-bold text-black">Quotation Rekomendasi Edit</a>
     </div>
...
export default QuotationsRecomendEdit

QuotationsRecomendEdit.layout = (page) => <Layout auth={page.props.auth} errors={page.props.errors}>{page}</Layout>;
