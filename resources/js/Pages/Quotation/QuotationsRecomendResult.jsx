  ...
  return (
    <div className="min-h-screen bg-abu ">
      ...
      <div className="flex justify-between m-6 mt-2 mb-3">
        <a className="text-2xl font-bold text-black">Quotation ID001</a>
      </div>
              ...
              <div className="flex flex-row">
                ...
                <div className="flex flex-col pt-24 pb-8">
                  <form className="space-y-3 font-medium text-left">
                    ...
                    <label className="label">
                      <span className="label-text text-black">Industrial el Visit</span>
                    </label>
                    <label className="label">
                      <span className="label-text text-black">
                        250
                    ...
                    <label className="label">
                      <p className="label-text text-black">Yogyakarta</p>
                    </label>
                    <label className="label">
                      <span className="label-text text-black">3</span>
                    </label>
                    <label className="label">
                      <span className="label-text text-black">
                        Rp.799.000/pax
